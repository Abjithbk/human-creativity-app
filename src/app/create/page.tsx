...
import { Upload, X, Sun, Moon, ArrowLeft } from "lucide-react"; 
    ...
    <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white flex items-center justify-center p-4 relative transition-colors duration-300">
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-zinc-500">Show your creativity to the world</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Image Upload Area */}
          <div className="relative group">
            <div className={`border-2 border-dashed rounded-2xl p-8 transition-colors text-center cursor-pointer 
          ...
          >
            {loading ? "Uploading..." : "Post Artwork"}
          </button>
        </form>
      </div>
    </div>
