      ...
      <div className="p-root">
        ...
        <div className="p-inner">
          ...
          <div className="flex items-center justify-center gap-12 w-full mb-8 py-4 border-y border-gray-200 dark:border-gray-800 bg-gray-50/40 dark:bg-transparent">
            <StatCard value={userProfile?.posts?.length ?? 0} label="Creations"  icon={<Grid3X3 size={16} />} />
            <StatCard value={userProfile?.followers?.length ?? 0} label="Followers"  icon={<Grid3X3 size={16} />} />
            <StatCard value={userProfile?.following?.length ?? 0} label="Following"  icon={<Grid3X3 size={16} />} />
          </div>
